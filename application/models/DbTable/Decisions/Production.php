<?php
	class Model_DbTable_Decisions_Production extends Zend_Db_Table{
		...
		//En principio no vamos a usar esta funciÃ³n
		...
		//por el mometo nos da la región en la que establecemos la primera fábrica
		//más adelante incluiremos el resto, pero por el momento podemos funcionar con
		...
		//ahora no se usa en initProdoction pero puede ser util mÃ¡s adelante
		//Â¿Puede dar problemas si sacamos primero la ronda y luego la fÃ¡brica? Â¿Por quÃ© no hacerlo por regiÃ³n? Revisar bien esto porque puede tener gran impacto en los bucles.
