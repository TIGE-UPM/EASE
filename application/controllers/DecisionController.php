<?php
	class DecisionController extends Zend_Controller_Action {
		...
		function marketingAction(){
			...
			$marketingCampaign[2]=array('campaign_value'=>3, 'name'=> 'Un móvil para todos');
		...
		function humanresourcesAction(){
			...
			$employeeCategory[0]=array('category_number'=>1, 'name'=>'Operario de fabricación');
			...
			$employeeCategory[3]=array('category_number'=>4, 'name'=>'Técnico de mantenimiento');
